...
public class Account {
	...
	public static Consumer<Account> add100 = e -> e.balance+=100;
	...
	public static Predicate<Account> checkBound = a -> lowerBound.and(upperBound).test(a);
	...
	// TODO: Task3 
	// replace the null with a lambda expression
	public static AddMaker maker = (int N) -> e -> e.balance+=N;
